...
#ifndef PROGPRACTICE2_MY_CIRCUIT_SORTEDLIST_H
#define PROGPRACTICE2_MY_CIRCUIT_SORTEDLIST_H
...
typedef struct {
    ...
    NodeC * head;	 	// Head/First element or Phantom node;
    NodeC * previous; 	// Previous node before the point of view;
    int size;
} SortedListC;
...
#endif //PROGPRACTICE2_MY_CIRCUIT_SORTEDLIST_H
